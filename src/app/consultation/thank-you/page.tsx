...
export const metadata: Metadata = {
  ...
  description:
    "Your 1-on-1 call with Cade Ford has been booked. Check your email for the calendar invite and prep instructions.",
  openGraph: {
    title: "Call Confirmed | Capital Growth Club",
    description:
      "Your 1-on-1 call has been booked. Check your email for the calendar invite and prep instructions.",
    url: "https://capitalgrowthclub.com/consultation/thank-you",
    type: "website",
  },
  twitter: {
...
const PREP_ITEMS = [
  {
    ...
    desc: "You'll receive a confirmation email shortly, followed by a calendar invitation. The call link will be inside that invite.",
  },
  {
    title: "Write down what you want to cover",
    desc: "Having your specific questions or goals written down ahead of time makes the call faster and more useful.",
  },
  {
    title: "Join on a desktop if possible",
    desc: "A desktop or laptop makes it easier to share screens and review work together, if needed.",
  },
];
      ...
      <section className="relative flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-5 leading-tight">
            ...
            <span className="gradient-text">call with Cade.</span>
          </h1>
          <p className="text-white/60 text-lg leading-relaxed mb-10">
            You&apos;ll get a confirmation email shortly, followed by a
            calendar invitation with the call link. Here&apos;s how to make
