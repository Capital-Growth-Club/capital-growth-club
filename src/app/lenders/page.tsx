          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                solution: "We build automated reminder sequences — text and email — that confirm the appointment, remind them the day before, and re-engage no-shows. The difference between a calendar full of no-shows and a calendar full of qualified prospects is the system you wire up behind the booking.",
              },
              {
