...
export const metadata: Metadata = {
  title: "Lending Strategy Call Booked — Please Read Before Leaving",
  description:
    "Your Capital Growth Club lending strategy call is confirmed. Read the pre-call requirements before leaving this page so we make the most of our time together.",
  openGraph: {
    title: "Lending Strategy Call Booked | Capital Growth Club",
    description:
      "Your lending strategy call is confirmed. Read the pre-call requirements before leaving this page.",
    url: "https://capitalgrowthclub.com/booked-lenders",
    type: "website",
  },
  twitter: {
...
const rules = [
  ...
  "Be on time. No-shows and reschedules give your slot away to the next lender in line.",
  "Be at a computer in a quiet space with a stable internet connection — not in the car, not between closings.",
  "If you have a partner or anyone else involved in the decision, they must be on the call with you.",
  "Come ready to talk numbers: your monthly loan volume, the loan products you lead with, your primary lending markets, and where your borrowers come from today.",
];

export default function BookedLendersPage() {
  return (
    <main
      className={`${helveticaBold.variable} min-h-screen bg-white text-neutral-900 relative overflow-hidden flex flex-col`}
    >
      <ScheduleEventFire funnel="lenders" />
        ...
        <div className="max-w-2xl mx-auto w-full">
          <div className="text-center mb-10">
            <div className="inline-flex items-center bg-gradient-to-r from-neutral-900/[0.06] via-neutral-900/[0.03] to-neutral-900/[0.06] border border-neutral-900/25 rounded-full pl-[calc(1rem+0.28em)] pr-4 pt-3 pb-2 mb-6 shadow-sm shadow-neutral-900/10">
              <span
                className={`${editorialSerif.className} text-neutral-900 text-xs md:text-sm tracking-[0.28em] uppercase leading-none`}
              >
                Call Confirmed
              </span>
            </div>
            ...
            <p className="text-neutral-600 text-lg leading-relaxed">
              We only take on lenders with a proven process behind the inquiry,
              and we reserve a real advisor for every call. The expectations
          ...
          <div className="bg-white border border-neutral-200 rounded-2xl shadow-sm shadow-neutral-900/5 p-6 md:p-8 mb-8">
            <p
              className={`${editorialSerif.className} text-neutral-900 text-xs tracking-[0.28em] uppercase mb-6 text-center leading-none`}
            >
              Before The Call
            </p>
